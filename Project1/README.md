...
var $j = jQuery.noConflict(true); $(document).ready(function(){ console.log($().jquery); // This prints v1.11.0 console.log($j().jquery); // This prints v3.1.0 });
...
The code for this project consists of several Python files, some of which you will need to read and understand in order to complete the assignment, and some of which you can ignore. You can download all the code and supporting files as a [zip archive](https://drive.google.com/file/d/1i1foFzBQNPue6epONOJIfoVMvhsSOgKO/view?usp=sharing).
...
**Files to Edit and Submit:** You will fill in portions of `search.py` and `searchAgents.py` during the assignment. Once you have completed the assignment, you will submit a zip file containing these two files. Please _do not_ change the other files in this distribution or submit any of our original files other than these files.
...
After downloading the code (`[search.zip](https://drive.google.com/file/d/1i1foFzBQNPue6epONOJIfoVMvhsSOgKO/view?usp=sharing)`), unzipping it, and changing to the directory, you should be able to play a game of Pacman by typing the following at the command line:
